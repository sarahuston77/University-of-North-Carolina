...
# Data manipulation
## Cleans up the RMD output and files by ensuring they don't fall off the page. A lot of lying with statistics is appearing credible. Thus, I used the "knitr" and "readr" libraries to clean up the graph outputs and ensure there is no run off text in the pdf. This gives the document a clean and clear feel. I used StackOverflow to figure out how to do this and include it in all of my markdowns. 
...
### The data used was from a longitudional study of 674 children over 4 years. 
