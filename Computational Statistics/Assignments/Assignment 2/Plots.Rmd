...
# Assignment 1
## Data Manipulation
### Install and load all required pacakges (Don't install in rmd)
```{r}
...
### Describe the distributions in two sentences: Perceived discrimination decreases from wave 1 to wave 4, with an increase of ~100 in 1 scores. Alcohol, tobacco, or other drug use increased heavily from wave 1 to wave 4. 
