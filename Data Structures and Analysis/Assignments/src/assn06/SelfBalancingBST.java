...
public interface SelfBalancingBST<T extends Comparable<T>> {
    ...
    /**
     * Tests whether this tree contains all integer elements within the specified range,
     * from start to end inclusive (see tests given in Main).
     * @param start the starting element of the range to check.
     * @param end the ending element of the range to check.
     * @return true if this tree contains every integer element within the specified range,
     * including the start and end elements; false if any element in the range is missing.
     */
